...
def calculates_results_stats(results_dic):
    ...
    # this function 
# Initialize the dictionary to store the results statistics
    results_stats_dic = {}

    # Calculate various statistics based on the results_dic
    ...
    # Add the calculated statistics to the results_stats_dic
